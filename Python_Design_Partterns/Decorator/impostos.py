...
def IPVX(metodo_ou_funcao):
    #chama o cálculo do imposto ISS, pega o resultado e soma com 50
    def wrapper(self, orcamento): #self do ISS wrapper ou qualquer nome
        resultado_metodo_ou_funcao = metodo_ou_funcao(self, orcamento) + 50.0
        return resultado_metodo_ou_funcao
    return wrapper
